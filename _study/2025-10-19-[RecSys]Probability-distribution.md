...
![image](/assets/images/2025-10-19-23-09-50.png)

중심극한정리는 독립적인 확률 변수들의 합이나 평균이 표본의 크기가 커질수록 정규분포에 근사하는 현상이다.

$$X_n$$은 독립적이고 동일한 분포를 가진 i.i.d확률변수
...
```
![image](/assets/images/2025-10-19-22-26-36.png)
![image](/assets/images/2025-10-19-22-26-41.png)
![image](/assets/images/2025-10-19-22-26-46.png)
...
![image](/assets/images/2025-10-19-23-10-24.png)
...
![image](/assets/images/2025-10-19-22-27-21.png)

베타분포의 PDF는 $\alpha, \beta$에 의해서 결정된다.

![image](/assets/images/2025-10-19-22-27-34.png)
...
![image](/assets/images/2025-10-19-22-27-43.png)
...
![image](/assets/images/2025-10-19-22-28-09.png)

감마분포: 시간을 모델링하는 연속 확률 분포

![image](/assets/images/2025-10-19-22-28-32.png)
...
![image](/assets/images/2025-10-19-22-28-41.png)
...
![image](/assets/images/2025-10-19-22-28-55.png)
```python
import numpy as np
import matplotlib.pyplot as plt
...
posterior_distribution = norm(mu_posterior, sigma_posterior)  
...
![image](/assets/images/2025-10-19-22-29-06.png)
...
![image](/assets/images/2025-10-19-22-29-22.png)
...
![image](/assets/images/2025-10-19-22-29-31.png)

$$\alpha = 1, \beta = 1$$에서 파란색과 빨간색 그래프가 일치함을 확인할 수 있다.

## Gamma분포 - Exponential분포

![image](/assets/images/2025-10-19-22-29-49.png)
...
![image](/assets/images/2025-10-19-22-29-59.png)

감마분포에서 $$\alpha=1$$로 주었을때 지수분포와 같음을 확인할 수 있다..

## Binomial분포 - Normal분포

![image](/assets/images/2025-10-19-22-30-09.png)
...
![image](/assets/images/2025-10-19-22-30-17.png)
