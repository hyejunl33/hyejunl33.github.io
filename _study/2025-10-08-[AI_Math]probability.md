...
$$P(A\mid B)$$: `p_software_given_critical` : 비판적 리뷰일때 소프트웨어 관련 피드백일 확률

$$P(A\mid B^C)$$: `p_software_given_positive` :긍정적 리뷰일때 소프트웨어 관련 피드백일 확률

위의 4가지 확률이 주어졌을떄 아래의 확률을 구해보자.

(1) 소프트웨어 관련 피드백이라면, 비판적인 리뷰가 포함되었을 확률 $$𝑃(𝐵\mid 𝐴)$$

(2) 하드웨어 관련 피드백이라면, 비판적인 리뷰가 포함되었을 확률 $$𝑃(𝐵\mid 𝐴^𝐶)$$

(3) 소프트웨어 관련 피드백이라면, 긍정적인 리뷰가 포함되었을 확률 $$𝑃(𝐵^𝐶\mid 𝐴)$$

(4) 하드웨어 관련 피드백이라면, 긍정적인 리뷰가 포함되었을 확률 $$𝑃(𝐵^𝐶\mid 𝐴^𝐶)$$
